...
class GeneralizedRelationalConv(MessagePassing):
    ...
    def message_and_aggregate(
        ...
        for tensor in [
            ...
            boundary,
            degree_out,
            sum if 'sum' in locals() else None,
            sq_sum if 'sq_sum' in locals() else None,
            max if 'max' in locals() else None,
            min if 'min' in locals() else None,
            mean if 'mean' in locals() else None,
            sq_mean if 'sq_mean' in locals() else None,
            std if 'std' in locals() else None,
            features if 'features' in locals() else None,
            scale if 'scale' in locals() else None,
            scales if 'scales' in locals() else None,
        ]:
